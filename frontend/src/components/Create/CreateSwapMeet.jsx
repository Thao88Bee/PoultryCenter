...
function CreateSwapMeet() {
  ...
  useEffect(() => {
    ...
    if (!name.length) {
      errors.name = "Please enter your Swap Meet Name";
    }
    if (!date) {
  ...
  const onSubmit = async (e) => {
    ...
    const getSwapMeet = await dispatch(createSwapMeetThunk(newShow));
    ...
    navigate(`/swapMeets/${getSwapMeet.id}`);
  };

  return (
    <>
      <div className="create">
        <h2 className="createTitle">Add a New Swap Meet</h2>
