...
const swapMeets = [
  ...
  },
  {
    ...
    date: "2025-05-10",
    description: "8am-12pm.Poultry, small animals, baked goods, crafts, etc are allowed!",
  ...
  },
  {
    ...
    date: "2025-03-22",
    description: "Sellers may set up at 7:30 am no pre signup required just show up. Buyers will not be allowed entry until 8am.",
  ...
  },
  {
    ...
    date: "2025-04-19",
    description: "Admission is $2, children under twelve free. $5 to sell outside, $10 inside.",
    address: "Hwy. 11 East",
    city: "Elkhorn",
    state: "Wisconsin",
  },
  {
    ...
    date: "2025-06-07",
    description: "$10.00 vendor fee at gate. Buyers are free to enter. Sellers encouraged to set up at least half hour early.",
